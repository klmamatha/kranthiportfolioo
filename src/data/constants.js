...
export const education = [
  {
    ...
    grade: "8.45 CGPA",
    desc: "I am completed Master's degree in Contol system Engineering at Jawaharlal Nehru Technological University ,Anantapur.",
    degree: "Master of Technology - M-Tech, Contol systems Engineering",
  },
  {
    id: 1,
    img: Audisankara,
    ...
    grade: "79.64%",
    desc: "I am completed Bachelor's degree in  Electrical and Electronics Engineering at Audisankara College of Engineering & Technology,Gudur.",
  ...
  },
  {
    ...
    grade: "87.46%",
    desc: "I completed  Diploma in Electrical and Electronics Engineering at Govt.Polytechnic ,Anantapur",
...
export const projects = [
  ...
  },
  {
    ...
    webapp: "https://emart-one-delta.vercel.app/",
    member: [
      {
        name: "Kranthi kumar",
        img: Hero,
...
export const TimeLineData = [
  ...
  { year: 2022, text: "Started Job In TCS" },
  { year: 2023, text: "Complted one year In TCS" },
  { year: 2024, text: "Complted two year's In TCS" },
  { year: 2025, text: "Complted Three year's In TCS" }
];
